...
export function DashboardContent() {
  ...
  const metrics = [
    { label: "Veículos no fechamento", value: ranking ? String(ranking.totalVehicles) : "—", detail: ranking?.label ?? "Nenhum fechamento" },
