...
export function SettingsContent() {
  ...
  return <div className="settings-page">
    ...
    <section className="settings-grid">
      <article className="panel settings-card"><span><ShieldCheck size={22} /></span><div><h3>Regra do ranking</h3><p>Toda placa produzida no período é considerada, independentemente da situação atual. Cada placa vale 1 ponto. Empates são resolvidos pela maior previsão financeira.</p></div><strong><CheckCircle2 size={16} /> Ativa</strong></article>
